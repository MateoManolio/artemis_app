...
void main() {
  ...
  group('ArticleRepositoryImpl', () {
    group('getArticle', () {
      test('should return DataSuccess with article when datasource succeeds', () async {
        // Arrange
    ...
    group('getArticles', () {
      test('should return DataSuccess with articles list when datasource succeeds', () async {
        // Arrange
        final workDtos = [
          WorkDto(
    ...
    group('getAutocompleteArticles', () {
      test('should return DataSuccess with articles when datasource succeeds', () async {
        // Arrange
        const query = 'test';
        final workDtos = [
          WorkDto(
        ...
        when(() => mockDatasource.getAutocompleteArticle(query))
            .thenAnswer((_) async => createDataSuccess(workDtos));
    ...
    group('getRandomArticle', () {
      test('should return DataSuccess with random article', () async {
        ...
        when(() => mockDatasource.getRandomArticle())
            .thenAnswer((_) async => createDataSuccess(workDto));
