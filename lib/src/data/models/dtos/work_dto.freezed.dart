...
@AbstractInvertedIndexConverter() Map<String, List<int>>? get abstractInvertedIndex; List<CountByYearDto>? get countsByYear;@DateTimeConverter() DateTime? get updatedDate;@DateTimeConverter() DateTime? get createdDate;
...
/// OpenAlex entrega el abstract como inverted index (no texto plano).
/// Lo modelamos como Map\<String, List\<int\>\> y lo reconstruimos fuera.
@override@AbstractInvertedIndexConverter() Map<String, List<int>>? get abstractInvertedIndex {
